...
const PrivacyPolicy = () => (
  <Layout>
    ...
    <p>
      ...
      hoover-honey.myshopify.com PERSONAL INFORMATION WE COLLECT When you visit
      the Site, we automatically collect certain information about your device,
      ...
      browse the Site. Additionally when you make a purchase or attempt to make
      a purchase through the Site, we collect certain information from you,
      ...
      about Device Information and Order Information. HOW DO WE USE YOUR
      PERSONAL INFORMATION? We use the Order Information that we collect
      generally to fulfill any orders placed through the Site (including
      processing your payment information, arranging for shipping, and providing
      you with invoices and/or order confirmations). Additionally, we use this
      ...
      our products or services. We use the Device Information that we collect to
      ...
      advertising campaigns). SHARING YOUR PERSONAL INFORMATION We share your
      ...
      communications we believe may be of interest to you. For more information
      ...
      Track signal from your browser. YOUR RIGHTS If you are a European
      resident, you have the right to access personal information we hold about
      you and to ask that your personal information be corrected, updated, or
      deleted. If you would like to exercise this right, please contact us
      through the contact information below. Additionally, if you are a European
      ...
      States. DATA RETENTION When you place an order through the Site, we will
      maintain your Order Information for our records unless and until you ask
      us to delete this information. CHANGES We may update this privacy policy
      from time to time in order to reflect, for example, changes to our
      ...
      e‑mail at hooverjarod@gmail.com or by mail using the details provided
      below: Hoover Honey [Re: Privacy Compliance Officer] Hoover Honey,  3505
      Marina Link,  Weatherford TX 76087, United States
    </p>
  </Layout>
)
